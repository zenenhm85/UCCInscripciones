...
<body id="page-top">
  ...
  <!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <!-- Begin Page Content -->
        <div class="container-fluid" id="inscricao2">

          <!-- Page Heading -->
          <div class="row">
            <div class="col-2"> <button  class="btn btn-primary fa-1x btn-circle" data-toggle="modal" data-target="#inseririnscricaoModal2" title="Nova Inscrição"><i class="fa fa-plus-circle" ></i></button></div>
            <div class="col-8"><h1 class="h3 mb-0 text-gray-800 text-uppercase text-center float-center">Lista de Inscrições II</h1></div>
            <div class="col-2">
              <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                <div class="input-group">
                  <input type="text" class="form-control bg-light border-0 small border-left-primary" placeholder="Procurar pelo BI..." aria-label="Search" aria-describedby="basic-addon2" maxlength="14" id="procurarbiincrivir2" v-model="procurarbiincrivir" @keyup="procurarAluno"  onkeydown="pulsar(event)">                 
                </div>
              </form>
            </div>
          </div>    
          ...
          <!-- Modal Inserir-->
                <div class="modal fade" id="inseririnscricaoModal2" tabindex="-1" role="dialog" aria-labelledby="InserirCurso" aria-hidden="true">
                      ...
                      <div class="modal-body">
                        <form>
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" id="bialunoinscrever2"  onkeydown="pulsar(event)">
                            </div>
                          </div> 
                          <div class="form-group row">
                              <label class="col-sm-3 col-form-label">Ano:</label>
                              <div class="col-sm-9"> 
                                <select id="anoinscricao2" class="form-control" v-model="ano">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-9"> 
                                <select id="cursosinscricao2" class="form-control" multiple="multiple">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-9"> 
                                <select id="cursosinscricaop2" class="form-control" multiple="multiple">
                                  <option v-for="item3 in cursos">{{item3.nome}}</option>                
                                </select>
                              </div>
                          </div>                                                 
                  ...
                  <!-- Fim Modal Inserir-->                              
                  <!-- Modal Excluir-->
                <div class="modal fade" id="excluirinscricaoModal2" tabindex="-1" role="dialog" aria-labelledby="InserirCurso" aria-hidden="true">
                  <div class="modal-dialog modal-md" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
