...
<body id="page-top">
  <!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <!-- Begin Page Content -->
        <div class="container-fluid" id="publicarnota2">
          <!-- Page Heading -->
          <div class="row">
            <div class="col-1">
            ...
            <div class="col-4">
              <h1 class="h3 mb-0 text-gray-800 text-uppercase text-center float-center">Publicar Notas II</h1>
            </div>
            <div class="col-1">              
              <div class="form-group row">                
                <div class="col-sm-12"> 
                        ...
                        <div class="row">                         
                          <div class="col-12">
                            <table border="1"  id="exportarnotas" class="table  table-bordered" cellspacing="0" width="100%">
                                ...
                                <tr>
                                  <td colspan="6" class="text-center"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Exame de Acesso {{ano}}</b> (segunda convocatória)</td>
                                </tr>                                  
                                <tr>                                  
