...
<body id="page-top">
  <!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <!-- Begin Page Content -->
        <div class="container-fluid" id="relatorio6">
          <!-- Page Heading -->
          <div class="row">
            <div class="col-1">
            ...
            <div class="col-4">
              <h1 class="h3 mb-0 text-gray-800 text-uppercase text-center float-center">Notas Pauta Geral</h1>
            </div>
            <div class="col-1">              
              <div class="form-group row">                
                <div class="col-sm-12"> 
                  ...
                  <table class="table table-bordered table-hover" id="notasadmitidos">
                      <thead class="bg-gradient-primary">                        
                        <tr>
                          ...
                          <th scope="col" class="text-center text-gray-100" style="width: 10%;">Admitido</th> 
                      ...
                      <tbody>                                                     
                        <tr v-for="item in listanotas">
                          ...
                          <td class="text-center" v-if="item.admitido==1">Sim</td>
                          <td class="text-center" v-else>Não</td>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title text-uppercase">Notas Pauta Geral</h5>
                        ...
                        <div class="row">                         
                          <div class="col-12">
                            <table border="1"  id="exportarnotasadmitidos" class="table  table-bordered" cellspacing="0" width="100%">
                                <tr>
                                  <td colspan="6" class="text-center text-uppercase">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RESULTADO DOS EXAMES DE ACESSO(Pauta Geral)</td>
                                </tr> 
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td scope="col" class="text-center" style="width: 15%;"><b>Admitido</b></td>
