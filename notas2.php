...
<body id="page-top">
  <!-- Page Wrapper -->
    <div id="wrapper">
        ...
        <!-- Begin Page Content -->
        <div class="container-fluid" id="notas2">
          <!-- Page Heading -->
          <div class="row">
            <div class="col-1">
            ...
            <div class="col-6">
              <h1 class="h3 mb-0 text-gray-800 text-uppercase text-center float-center">Inserir Notas II</h1>
            </div>
            <div class="col-3">              
              <div class="form-group row">                
                <div class="col-sm-12"> 
                  ...
                  <table class="table table-bordered table-hover">
                      ...
                      <tbody>                                
                        <tr v-for="item in listanotas">
                          ...
                          <td class="text-center">{{item.nota2}}</td>
                          <td class="text-center"><button class="btn btn-outline-secondary btn-circle" title="Alterar" data-toggle="modal" data-target="#alterarnotaModal" @click="brnAlterar(item.bi,item.nota2)"><i class="fa fa-pencil-alt fa-1x"></i></button></td> 
